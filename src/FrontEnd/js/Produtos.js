                        ...
                        produtos.forEach(produto => {
                            ...
                            produtoDiv.innerHTML = `
                             <div class="produto-detalhes">
                              <h3 classe="itens">${produto.Nome}</h3> 
                                <p classe="itens"><b>Nome:</b> ${produto.Nome}</p>
                                <p classe="itens"><b>Descrição:</b> ${produto.Descricao}</p>
                                <p classe="itens"><b>Preço:</b> R$ ${produto.Preco.toFixed(2)}</p>
